final enKeys = <String, String>{
  "citizen_des":
      "The citizen does not know anyone in the game and should try to identify the mafia and only have the power to vote and speak",
  "citizen_name": "Citizen",
  "doctor_des":
      "In the night phase of the game, he/she wakes up and saves a certain number of players who may have been killed",
  "doctor_name": "Doctor",
  "detective_des":
      "In the night phase, he/she investigate about a player who thinks he/she is a mafia member. If he/she is a godfather, he/she gets disapproval.",
  "detective_name": "Detective",
  "priest_des":
      "In the night phase, he/she heals a player who is guessed to be Muted",
  "priest_name": "Priest",
  "armor_des": "He/She does not die in the night phase due to shooting",
  "armor_name": "Armor",
  "sniper_des":
      "He/She is a citizen who has the ability to shoot the mafia in a certain number at night, but if he shoots wrong, he will die himself",
  "sniper_name": "Sniper",
  "mason_des":
      "In the night phase, he/she wakes up one citizen by guessing. If his/her guess is correct, the two citizens know each other, and if it is wrong, all the masons will die.",
  "mason_name": "Mason",
  "bomber_des":
      "In case of removal from the game, two player next to him/her will also be removed from the game",
  "bomber_name": "Bomber",
  "gunsmith_des":
      "In the night phase, he/she can give a gun to one of the players, and that player can use it to kill another player the next day before voting",
  "gunsmith_name": "GunSmith",
  "cowboy_des":
      "During Day, he/she can announce his/her role and take 1 player out of the game with himself/herself",
  "cowboy_name": "Cowboy",
  "hacker_des":
      "In the night phase, it tells a list of 3 players, and the next day God Tells on of three things: 1- The list is dangerous (if it is 1 mafia in the list) 2- The list is white (if there are 3 citizens or 2 mafias in the list) 3- If there are 3 mafias in the list, all 3 will leave the game",
  "hacker_name": "Hacker",
  "journalist_des":
      "Every night after the negotiation, the journalist investigate about the players and confirms if the player has been negotiated.",
  "journalist_name": "Journalist",
  "guardian_des":
      "In the night phase, it protects a certain number of players against the role blocker and does not leave the game during the day",
  "guardian_name": "Guardian",
  "comando_des":
      "He/She wakes up every night. If he/she is shot, he can return the shot. If he returns the shot to the Mafia, he/she stays in the Game.",
  "comando_name": "Comando",
  "hero_des":
      "Every 2 nights, He/She Protects 1 player from every action for 24 Hours",
  "hero_name": "Hero",
  "soldier_des":
      "He/She is the successor of the Sniper. When the Sniper dies, he/she will replace him/her",
  "soldier_name": "Soldier",
  "nurse_des":
      "He/She is the successor of the Doctor. When the Doctor dies, he/she will replace him/her",
  "nurse_name": "Nurse",
  "deputy_des":
      "He/She is the successor of the Detective. When the Detective dies, he/she will replace him/her",
  "deputy_name": "Deputy",
  "psycho_des":
      "He/She decides to kill player in one night and kills him/her with any side, effect without any consequences",
  "psycho_name": "Psycho",
  "devoted_des":
      "A citizen who can prevent a player from leaving game by giving his/her life",
  "devoted_name": "Devoted",
  "nexsus_des":
      "He/She stands behind a player every night. If any action is performed on him/her, it is performed on the selected player",
  "nexsus_name": "Nexsus",
  "mafia_des":
      "At night, know his/her partners and try to get the citizens out during the day",
  "mafia_name": "Mafia",
  "godfather_des":
      "The leader of all the mafias, he/she orders who to be killed at night, and his/her investegation resault is negative",
  "godfather_name": "GodFather",
  "silncer_des":
      "He/She wakes up every night and chooses a player, and that player has no right to speak or vote the next day",
  "silncer_name": "Silncer",
  "lawer_des":
      "Every night he/she takes on the role of a mafia lawyer, and that resault of investigation of that mafia becomes negative for detective",
  "lawer_name": "Lawer",
  "terrorist_des":
      "If he/she leaves the game by voting, he/she can take a citizen with him/her",
  "terrorist_name": "Terrorist",
  "strongman_des":
      "He/She does not wake up with the main mafia group and in one night he/she can shot a player and that player definitely will take out of the game",
  "strongman_name": "Strongman",
  "framer_des":
      "Every night he/she points to a citizen. If that player is questioned by the detective, the investigation resault will be declared positive",
  "framer_name": "Framer",
  "thief_des":
      "He/She does not know the rest of the mafias. He/She targets one player every night and if he/she has a role, he takes it for the same night.",
  "thief_name": "Thief",
  "spy_des":
      "If awakened by a Mason, he/she can penetrate between them and the Masons will not die.",
  "spy_name": "Spy",
  "poisenor_name": "Poisenor",
  "negotiator_des":
      "In one night, if a certain number of Mafias left the Group, he/she could make a citizen a member of the Mafia",
  "negotiator_name": "Negotiator",
  "lecter_des":
      "Wake up in the night phase of the game and can save a member of the Mafia",
  "lecter_name": "Lecter",
  "nato_des":
      "In the night phase, can guess the role of a citizen and take him/her out of the game",
  "nato_name": "Nato",
  "roleblocker_des":
      "Every night he/she wakes up apart from the main Mafia Group and takes some player hostage. If that player has the ability, he will lose it for that night.",
  "roleblocker_name": "Role Blocker",
  "professional_killer_des":
      "One night he/she target a player and if that player is in the game until three days later, he/she will be removed from the game",
  "professional_killer_name": "Professional Killer",
  "killer_name": "Killer",
  "joker_name": "Joker",
  "mistress_des":
      "If the mistress leaves the game, the Mafia will have two shots the next night instead of one",
  "mistress_name": "Mistress",
  "werewolf_des":
      "Every three nights he/she turns into a wolf and turns a player into a wolf. His/Her winning condition is take half of the city.",
  "werewolf_name": "Were Wolf",
  "if": "If",
  "settings": "Settings",
  "players_list": "Players List",
  "home_pick_button": "Pick Roles : @count",
  "home_least_player_snackbar":
      "Least Amount of Players is 5 You Added @selected_player Player",
  ...
  "kill": "Kill",
  "kill_player_message":
      "Are You Sure That You Wanna Kill These  @players  Player(s) ?",
  ...
  "role_count_warning":
      "You Have Chosen @role_count Roles but There is @player_count Players",
  ...
  "not_voted_message":
      "You Didnt Do Any Votings Yet Do You Wanna Procced to Night Stage ?",
  "submit_night_actions": "Submit Night Actions",
  "opt_p": "(Opt)",
  "yes": "Yes",
  "no": "No",
  "can_take_action_messagee":
      "This Player Cant Use His/Her Ability Do You Wanna Let Him/Her To Use It ?",
  ...
  "player_ability_blocked_message":
      "This Player Ability Had Been Blocked By Another Player, Do You Wanna Let Him/Her To Use It ?",
