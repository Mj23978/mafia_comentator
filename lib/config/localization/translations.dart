...
class AppStrings extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    "fa_IR": {
      ...
      "not_voted_message": "شما هنوز رأی گیری نکردید ایا میخواهید به فاز شب بروید ؟",
      "submit_night_actions": "ثبت رویداد شب",
      "opt_p": "(اختیاری)",
      "can_take_action_messagee": "این بازیکن نمیتواند از قابلیتش استفاده کند ایا مطمئنید میخواهید به این بازیکن اجازه استفاده از قابلیتش را بدهید ؟",
      // "force_action": "",
      "yes": "بله",
      "no": "خیر",
